                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomButton(onPress: () async {
                          ...
                          final response = await Provider.of<AuthProvider>(context, listen: false).login(userData);
                          Navigator.pop(context);
                          if(response){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const NavScreen()));
                            Toasts.showToast(Colors.green, 'Login Successful');
                          }
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            }, buttonText: "Reset Here", buttonColor: Colors.transparent, textColor: ColorUtils.Green, padding: EdgeInsets.zero, fontSize: 15,),
                          ),
                        ],
                      ),
                      Padding(
